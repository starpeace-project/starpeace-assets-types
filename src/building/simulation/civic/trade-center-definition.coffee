...
# @property {STARPEACE.industry.ResourceQuantity~JSON[]} products - products sold by this building
###
...
exports = module.exports = class TradeCenterDefinition extends SimulationDefinition
  ...
  @fromJson: (json) ->
    ...
    definition.products = _.map(json.products, ResourceQuantity.fromJson)
    definition
