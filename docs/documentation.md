...
* STARPEACE
    * .building
        ...
        * .simulation
            ...
            * [.DEFINITIONS](#STARPEACE.building.simulation.DEFINITIONS)
            * [.ConstructionQuantity](#STARPEACE.building.simulation.ConstructionQuantity)
                * [~JSON](#STARPEACE.building.simulation.ConstructionQuantity..JSON) : <code>object</code>
            * .bank
                * [.BankDefinition](#STARPEACE.building.simulation.bank.BankDefinition) ⇐ <code>STARPEACE.building.simulation.SimulationDefinition</code>
                    * [~JSON](#STARPEACE.building.simulation.bank.BankDefinition..JSON) : <code>object</code>
            * .civic
                * [.CapitolDefinition](#STARPEACE.building.simulation.civic.CapitolDefinition) ⇐ <code>STARPEACE.building.simulation.SimulationDefinition</code>
                    * [~JSON](#STARPEACE.building.simulation.civic.CapitolDefinition..JSON) : <code>object</code>
                * [.MausoleumDefinition](#STARPEACE.building.simulation.civic.MausoleumDefinition) ⇐ <code>STARPEACE.building.simulation.SimulationDefinition</code>
                    * [~JSON](#STARPEACE.building.simulation.civic.MausoleumDefinition..JSON) : <code>object</code>
                * [.PortalDefinition](#STARPEACE.building.simulation.civic.PortalDefinition) ⇐ <code>STARPEACE.building.simulation.SimulationDefinition</code>
            ...
            * .headquarters
                * [.HeadquartersDefinition](#STARPEACE.building.simulation.headquarters.HeadquartersDefinition) ⇐ <code>STARPEACE.building.simulation.SimulationDefinition</code>
                    * [~JSON](#STARPEACE.building.simulation.headquarters.HeadquartersDefinition..JSON) : <code>object</code>
            * .media
                * [.AntennaDefinition](#STARPEACE.building.simulation.media.AntennaDefinition) ⇐ <code>STARPEACE.building.simulation.SimulationDefinition</code>
                    * [~JSON](#STARPEACE.building.simulation.media.AntennaDefinition..JSON) : <code>object</code>
                * [.MediaStationDefinition](#STARPEACE.building.simulation.media.MediaStationDefinition) ⇐ <code>STARPEACE.building.simulation.SimulationDefinition</code>
                    * [~JSON](#STARPEACE.building.simulation.media.MediaStationDefinition..JSON) : <code>object</code>
            * .office
                * [.OfficeDefinition](#STARPEACE.building.simulation.office.OfficeDefinition) ⇐ <code>STARPEACE.building.simulation.SimulationDefinition</code>
                    * [~JSON](#STARPEACE.building.simulation.office.OfficeDefinition..JSON) : <code>object</code>
            * .park
                * [.ParkDefinition](#STARPEACE.building.simulation.park.ParkDefinition) ⇐ <code>STARPEACE.building.simulation.SimulationDefinition</code>
                    * [~JSON](#STARPEACE.building.simulation.park.ParkDefinition..JSON) : <code>object</code>
            * .residence
                * [.ResidenceDefinition](#STARPEACE.building.simulation.residence.ResidenceDefinition) ⇐ <code>STARPEACE.building.simulation.SimulationDefinition</code>
                    * [~JSON](#STARPEACE.building.simulation.residence.ResidenceDefinition..JSON) : <code>object</code>
            * .service
                * [.ResourceQuantity](#STARPEACE.building.simulation.service.ResourceQuantity) ⇐ <code>STARPEACE.building.simulation.SimulationDefinition</code>
            * .storage
                * [.ResourceQuantity](#STARPEACE.building.simulation.storage.ResourceQuantity) ⇐ <code>STARPEACE.building.simulation.SimulationDefinition</code>
            ...
            * .store
                * [.ResourceQuantity](#STARPEACE.building.simulation.store.ResourceQuantity) ⇐ <code>STARPEACE.building.simulation.SimulationDefinition</code>
...
**Kind**: static property of [<code>building</code>](#STARPEACE.building)
**Properties**
...
| imagePath | <code>string</code> | path to image file for building |
| tileWidth | <code>number</code> | width of building in game tiles |
...
**Kind**: static property of [<code>simulation</code>](#STARPEACE.building.simulation)
**Properties**

| Name | Type | Description |
| --- | --- | --- |
| resourceId | <code>string</code> | identifier of resource type required |
| quantity | <code>number</code> | total amount of resource required |
| maxVelocity | <code>number</code> | maximum amount of resource that can be used for construction per hour |
...
<a name="STARPEACE.building.simulation.DEFINITIONS"></a>

#### STARPEACE.building.simulation.DEFINITIONS
...
| maxLevel | <code>number</code> | maximum upgrade level of building |
| constructionInputs | [<code>Array.&lt;ConstructionQuantity&gt;</code>](#STARPEACE.building.simulation.ConstructionQuantity) | array of input quantities required for construction |
...
**Kind**: static property of [<code>bank</code>](#STARPEACE.building.simulation.bank)
...
**Kind**: static property of [<code>headquarters</code>](#STARPEACE.building.simulation.headquarters)
**Extends**: <code>STARPEACE.building.simulation.SimulationDefinition</code>  
**Properties**
...
| satelliteCategory | <code>string</code> | satellite category if building is flagged as satellite |
...
**Kind**: static property of [<code>media</code>](#STARPEACE.building.simulation.media)
**Extends**: <code>STARPEACE.building.simulation.SimulationDefinition</code>  
**Properties**
...
**Kind**: static property of [<code>office</code>](#STARPEACE.building.simulation.office)
**Extends**: <code>STARPEACE.building.simulation.SimulationDefinition</code>  
**Properties**
...
**Kind**: static property of [<code>park</code>](#STARPEACE.building.simulation.park)
**Extends**: <code>STARPEACE.building.simulation.SimulationDefinition</code>  
**Properties**
...
**Kind**: static property of [<code>residence</code>](#STARPEACE.building.simulation.residence)
**Extends**: <code>STARPEACE.building.simulation.SimulationDefinition</code>  
**Properties**

| Name | Type | Description |
| --- | --- | --- |
| residentType | <code>string</code> | identifier of resource type for which residence provides housing |
| capacity | <code>number</code> | capacity of resource for which building provides housing |
| efficiency | <code>number</code> | base efficiency of building |
| crimeResistence | <code>number</code> | base crime resistence of building |
| pollutionResistence | <code>number</code> | base pollution resistence of building |
...
<a name="STARPEACE.building.simulation.service.ResourceQuantity"></a>

##### STARPEACE.building.simulation.service.ResourceQuantity
Class representing service building simulation definition

**Kind**: static property of [<code>service</code>](#STARPEACE.building.simulation.service)
**Extends**: <code>STARPEACE.building.simulation.SimulationDefinition</code>  
**Properties**
...
<a name="STARPEACE.building.simulation.storage.ResourceQuantity"></a>

##### STARPEACE.building.simulation.storage.ResourceQuantity
Class representing storage building simulation definition

**Kind**: static property of [<code>storage</code>](#STARPEACE.building.simulation.storage)
**Extends**: <code>STARPEACE.building.simulation.SimulationDefinition</code>  
**Properties**
...
| Name | Type | Description |
| --- | --- | --- |
| resourceId | <code>string</code> | identifier of resource type of storage |
...
<a name="STARPEACE.building.simulation.store.ResourceQuantity"></a>

##### STARPEACE.building.simulation.store.ResourceQuantity
Class representing store building simulation definition

**Kind**: static property of [<code>store</code>](#STARPEACE.building.simulation.store)
**Extends**: <code>STARPEACE.building.simulation.SimulationDefinition</code>  
**Properties**
...
| labor | [<code>Array.&lt;ResourceQuantity&gt;</code>](#STARPEACE.industry.ResourceQuantity) | labor requirements for building |
| operations | [<code>Array.&lt;ResourceQuantity&gt;</code>](#STARPEACE.industry.ResourceQuantity) | array of resource quantities required for building operations |
| products | <code>Array.&lt;STARPEACE.building.simulation.store.StoreProduct&gt;</code> | array of output resource products sold by building |
...
| Name | Type | Description |
| --- | --- | --- |
| resourceId | <code>string</code> | identifier of resource type of customer |
| maxVelocity | <code>number</code> | maximum amount of resource that can be bought by customers per hour |
...
**Kind**: static property of [<code>industry</code>](#STARPEACE.industry)
**Properties**
...
| Name | Type | Description |
| --- | --- | --- |
| resourceId | <code>string</code> | identifier of resource |
| maxVelocity | <code>number</code> | maximum quantity of resource per hour |
| weightEfficiency | <code>number</code> | importance weight of efficiency on this quantity |
| weightQuality | <code>number</code> | importance weight of qualityy on this quantity |
...
| maxVelocity | <code>number</code> | maximum quantity of resource per hour |
| weightEfficiency | <code>number</code> | importance weight of efficiency on this quantity |
| weightQuality | <code>number</code> | importance weight of quality on this quantity |
...
| labelPlural | [<code>Translation</code>](#STARPEACE.language.Translation) | Translation with plural label of resource |
| unitId | <code>string</code> | Unique identifier of resource unit for this resource |
...
| labelPlural | [<code>Translation</code>](#STARPEACE.language.Translation) | Translation with plural label of unit |
...
**Kind**: static property of [<code>invention</code>](#STARPEACE.invention)
**Properties**
...
**Kind**: static property of [<code>language</code>](#STARPEACE.language)
**Properties**
...
**Kind**: static property of [<code>seal</code>](#STARPEACE.seal)
**Properties**

| Name | Type | Description |
| --- | --- | --- |
| id | <code>string</code> | Unique identifier of seal |
| nameShort | <code>string</code> | Short name for seal (same in all languages) |
| nameLong | <code>string</code> | Longer full name for seal (may be same as json.name_short; same in all languages) |
| buildingIds | <code>Array.&lt;string&gt;</code> | Array of building definition identifiers that can be constructed by seal |
